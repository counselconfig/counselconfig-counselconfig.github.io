...
I installed self-hosted agents on virtual machines for Azure Pipelines which acts as a computing infrastructure that runs one job at a time using Windows Services - it requires a Personal Access Token generated inside the Azure DevOps server. 
